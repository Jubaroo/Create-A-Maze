...
package org.jubaroo.wurmunlimited.mods.actions;
...
import org.jubaroo.wurmunlimited.mods.Cooldowns;
    ...
    public ActionPerformer getActionPerformer() {
        return new ActionPerformer() {
            ...
            public boolean action(final Action act, final Creature performer, final int tilex, final int tiley, final boolean onSurface, final int tile, final short action, final float counter) {
                ...
                if (performer.getPower() < LabyrinthAction.requiredGMlevel && Cooldowns.isOnCooldown(playerEffect, LabyrinthAction.cooldown)) {
