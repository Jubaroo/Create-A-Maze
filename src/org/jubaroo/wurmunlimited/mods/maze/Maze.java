...
import org.jubaroo.wurmunlimited.mods.StdRandom;
import org.jubaroo.wurmunlimited.mods.events.CreateMazeHedgeEvent;
import org.jubaroo.wurmunlimited.mods.events.GrowMazeHedgeEvent;
import org.jubaroo.wurmunlimited.mods.events.ShortEventDispatcher;
...
public class Maze
{
    ...
    public StructureConstantsEnum fenceType;
    private int offsetX;
    private int offsetY;
    ...
    public boolean createHedge(final Tiles.TileBorderDirection tbDir, final int x, final int y, final boolean animateGrowth) throws NoSuchZoneException, IOException {
        ...
        if (this.fenceType != StructureConstantsEnum.FENCE_STONEWALL_HIGH) {
